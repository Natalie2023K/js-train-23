...
class EmployeeIterator {
  ...
  next() {
    if(this.#hasNext()) {
    const index =  this.#employees[this.#currentIndex];
    this.#currentIndex ++;
    return true
    }
    return false
  ...
  // Конструктор приймає один параметр #currentIndex - об'єкт типу EmployeeGroup. Він ініціалізує властивість #employees this.#employees = employeeGroup.employees.
